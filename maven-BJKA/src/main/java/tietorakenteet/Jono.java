...
/**
 * Jono-tietorakenne, joka hyväksyy arvoiksi kokonaislukuja ja joka on optimoitu BJKA projektin käyttöön.
 * 
 * @author Chamion
 */
public class Jono {
    ...
    /**
     * Luo uuden jonon, joka on tyjä. Jonoon tallennettujen alkioiden määrä ei saa ylittää maxKokoa.
     * Alkioiden poistaminen jonosta vapauttaa tilaa uusille.
     * @param maxKoko Maksimimäärä arvoja, joita jonon tulee muistaa millä tahansa hetkellä.
     */
    ...
    /**
     * Poistaa ja palauttaa jonossa seuraavan alkion.
     * Vastaa dequeue-metodia.
